          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <img src="<?php echo base_url('assets');?>/img/forgot.jpg" title="forgot" alt="forgot" />
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo site_url('user/index');?>">Already have an account? Login!</a>
                  </div>
                </div>
              </div>
            </div>
