              ...
              <div class="form-group">
                ...
                <div class="check_boxs">
                 <label class="custom_check"> Everyone (Public Holiday)
                  <input type="checkbox" value="all staff" name="staff_check" class="all_checkeds" checked >
				    ...
				    { 
						...
						{ ?>
							<label class="custom_check" ><?php echo $value['first_name']." ".$value['last_name']; ?> 
							  <input checked type="checkbox" class="staffdis" value="<?php echo $value['id'];?> " <?php if($value['id'] == $staffid){echo "checked"; } ?> name="staff_id[]" class="check_inputs" id="staff_id">
							  <span class="checkmark"></span>
							</label>
				  <?php } 
				    }?>
